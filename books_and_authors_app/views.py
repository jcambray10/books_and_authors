...
def authors(request):
    return render(request, 'authors.html', {"authors": Book.objects.all()})
...
def show_book(request, book_id):
    ...
    context = {
        "book": book,
        "authors": Author.objects.exclude(books_id=book_id)
    }
...
def show_author(request, author_id):
    ...
    context = {
        "author": author,
        "books": Book.objects.exclude(authors_id=author_id)
    }
